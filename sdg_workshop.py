...
# Add button to download the original SDG data as a CSV file
csv = sdg_data.to_csv(index=False).encode('utf-8')
st.download_button(
    label="Download SDG Data as CSV",
    data=csv,
    file_name='sdg_data.csv',
    mime='text/csv'
)
